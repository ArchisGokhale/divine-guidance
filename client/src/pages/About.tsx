      ...
      <section className="py-20 bg-purple-900/95 backdrop-blur-sm relative overflow-hidden">
        ...
        <div ref={aboutRef} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            {/* Bio Section */}
            <div>
              <h2 className="text-4xl font-playfair font-bold text-white mb-6">About Sheetal Ghate</h2>
              <div className="w-24 h-1 bg-gradient-to-r from-yellow-400 to-yellow-500 mb-8"></div>
              ...
              {/* Credentials */}
              <div className="mt-12">
                <h3 className="text-2xl font-playfair font-semibold text-white mb-6">Spiritual Credentials</h3>
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="flex items-center p-4 bg-gradient-to-r from-purple-800 to-purple-700 rounded-lg border-2 border-yellow-400/50 shadow-lg">
                    <div className="text-2xl text-yellow-300 mr-4">🔱</div>
                    <span className="text-gray-200 font-medium">Certified in KP & Nadi Astrology</span>
                  </div>
                  <div className="flex items-center p-4 bg-gradient-to-r from-purple-800 to-purple-700 rounded-lg border-2 border-yellow-400/50 shadow-lg">
                    <div className="text-2xl text-yellow-300 mr-4">🌺</div>
                    <span className="text-gray-200 font-medium">Trained in Palmistry from Kashi Gurukul</span>
                  </div>
                  <div className="flex items-center p-4 bg-gradient-to-r from-purple-800 to-purple-700 rounded-lg border-2 border-yellow-400/50 shadow-lg">
                    <div className="text-2xl text-yellow-300 mr-4">🔯</div>
                    <span className="text-gray-200 font-medium">Member – Indian Council of Occult Studies</span>
                  </div>
                  <div className="flex items-center p-4 bg-gradient-to-r from-purple-800 to-purple-700 rounded-lg border-2 border-yellow-400/50 shadow-lg">
                    <div className="text-2xl text-yellow-300 mr-4">📿</div>
                    <span className="text-gray-200 font-medium">Personalized readings with Vedic remedies</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* Testimonials Section - LAST PANEL */}
